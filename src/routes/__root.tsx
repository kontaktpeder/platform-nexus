...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Platform Core" },
      { property: "og:description", content: "Operativsystemet som binder Finance, Work, Booking, Content og alle andre Core-moduler sammen." },
