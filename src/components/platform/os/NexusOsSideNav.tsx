...
/**
 * Bubbly OS sidebar — chrome sphere home, pill nav, capture bubbles, profile avatar.
 */
          ...
          return (
            ...
            >
              ...
              {item.badge != null && item.badge > 0 && (
                <span
                  className={cn(
                    "absolute right-1 top-1 flex size-4 items-center justify-center rounded-full text-[9px] font-bold xl:static xl:ml-auto xl:size-auto xl:px-1.5 xl:py-0.5 xl:text-[10px]",
                    active
